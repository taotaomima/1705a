...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/day04?user=root&password=1111&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("t_engineer","Engineer","day04").init();  
        new GenEntityOracle("t_profession","Profession","day04").init();
    } 
}